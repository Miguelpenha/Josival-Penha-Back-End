...
import { Container, Message, MessageText, ContainerVideo, IconClose, IconContact, IconShare, Video } from './style'
    ...
    return (
        <Container id="video-popup">
            ...
            <ContainerVideo className="container-video">
                ...
                <IconContact id="icon-contact" className="icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 308 308">
                    <g>
