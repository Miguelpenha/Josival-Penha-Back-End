...
const voiceFlowRouter = express.Router()

voiceFlowRouter.get('/', (req, res) => {
  res.json({
    success: true,
...
voiceFlowRouter.post('/webhook', async (req, res) => {
...
voiceFlowRouter.get('/webhook', (req, res) => {
  /**
...
export default voiceFlowRouter